...
//		private var boxNames:ComboBox;
		...
		*/
		...
		public function newGameGo():void {
			...
			// Goddess Stuff
			if (!player.hasPerk(PerkLib.Goddess) && player.hasPerk(PerkLib.NinetailsKitsuneOfBalance) && player.hasPerk(PerkLib.BloodlineDragon) && player.hasPerk(PerkLib.BloodlineKitsune)) {
			
				player.createPerk(PerkLib.Goddess, 0, 0, 0, 0);
			}
		}
